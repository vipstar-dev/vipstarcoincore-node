...
/**
 * Will return the path and htmlcoincore-node configuration
...
function findConfig(cwd) {
  ...
  while (!fs.existsSync(path.resolve(directory, 'htmlcoincore-node.json'))) {
  ...
  return {
    path: directory,
    config: require(path.resolve(directory, 'htmlcoincore-node.json'))
  };
}
