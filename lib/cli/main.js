...
function main(servicesPath, additionalServices) {
  ...
  program
    ...
    .action(function(services){
      ...
      if (!configInfo) {
        throw new Error('Could not find configuration, see `htmlcoincore-node create --help`');
      }
      var opts = {
      ...
      console.log();
      console.log('    $ htmlcoincore-node add wallet-service');
      console.log('    $ htmlcoincore-node add htmlcoin-api');
      console.log();
    });
  ...
  program
    ...
    .action(function(services){
      ...
      console.log('  Examples:');
      console.log();
      console.log('    $ htmlcoincore-node remove wallet-service');
      console.log('    $ htmlcoincore-node remove htmlcoin-api');
      console.log();
    });
